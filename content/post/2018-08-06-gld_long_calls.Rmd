...
```{r gld uup annual, echo=FALSE,warning=FALSE,message=FALSE,include=FALSE}
...
```{r gld uup cum returns, echo=FALSE,warning=FALSE,message=FALSE,include=FALSE}
...
```{r gld uup cum returns 2018, echo=FALSE,warning=FALSE,message=FALSE,include=FALSE}
...
```{r gld options, echo=FALSE,warning=FALSE,message=FALSE,include=FALSE}
...
gld_call %>%
  ...
  mutate(index = "GLD") %>%
  rename(Symbol = index) %>%
  kable(caption = "Call Option Chain OCt 2018") %>%
...
```{r gld option trade, echo=FALSE,warning=FALSE,message=FALSE,include=FALSE}
...
Our max loss on the trade is \$0.14 and max profit is $0.86. This trade will expire in 74 days and we may re-adjust or close it before.
