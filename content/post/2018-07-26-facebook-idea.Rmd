---
title: "Facbook disappoints! Stock down 20%"
...
tags:
  ...
  - facebook
  - stock
description: "Is this the worst decline for Facbook? How can we profit from this?"
---

Yesterday Facbook reported their earnings after market hours and investors were not pleased. They sent the stock down almost 25% at one point. Right now the stock is down about 20%. We wanted to check if this was the worst performance for Facbook stock since the IPO
...
As we can see there has been worse 5 day performance for Facebook stock in the past, but majority of the time the selloff has been contained within the 15% to 20% range.

So how can one trade this event.

After such as dramatic selloff, the implied volatility of the options spike higher. One potential trade idea is to sell the volatility (be short vol).
...
At this moment the \$1.27 is not enough compensation to take this risk. So we will continue to montitor this stock.
