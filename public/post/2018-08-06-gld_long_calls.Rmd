...
```{r gld uup annual ,warning=FALSE,message=FALSE}
...
```{r gld uup cum returns ,warning=FALSE,message=FALSE}
...
```{r gld uup cum returns 2018, warning=FALSE,message=FALSE}
...
```{r gld options, warning=FALSE,message=FALSE}
...
```{r gld option trade, warning=FALSE,message=FALSE}
